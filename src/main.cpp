...
int64 nChainStartTime = 1466116767;
...
const string strMessageMagic = "ChinaTimesCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in ChinaTimesCoin
    bool fStrictPayToScriptHash = true; // Always active in ChinaTimesCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ChinaTimesCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "block base target is fixed in testne ChinaTi mesCoin";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 717247 : 717247;
		...
		block.print();
		assert(block.hashMerkleRoot == uint256("0x930d154f69bdc05f267388d4f3ba290dc808587109a439c3698150248a6e42f2"));
...
unsigned char pchMessageStart[4] = { 0xe9, 0xe3, 0xbe, 0xc7 };
